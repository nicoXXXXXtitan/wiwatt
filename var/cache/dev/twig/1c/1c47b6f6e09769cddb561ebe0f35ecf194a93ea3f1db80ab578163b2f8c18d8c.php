...
class __TwigTemplate_56504f1c123fc60e242153039155229e08f578affcf79f5adefc32403cda02bb extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"page_error row d-flex mt-5 mb-4\">     
            <div class=\"col col-xs-6  ml-3\">
                ...
                <h2 class=\"page_error_number_error ml-5\">";
        // line 8
        ...
        echo " - accès refusé</h2>
            </div>
            <div class=\"col col-xs-6 page_error_right_part d-flex flex-column justify-content-center text-center mt-4 mr-5\">              
                <h2 class=\"page_error_h2\"> Désolé </h2>
                <h3 class=\"page_error_h3 pb-3\">Vous n'avez pas accès à cette partie.</h3>
                <div >
...
";
        // line 21
        $this->loadTemplate("partials/footer.html.twig", "@Twig/Exception/error403.html.twig", 21)->display($context);
        // line 22
        echo "
";
...
<div class=\"container-fluid\" >
    <div class=\"page_error row d-flex mt-5 mb-4\">     
            <div class=\"col col-xs-6  ml-3\">
                <h1 class=\"page_error_oups\">OUPS !</h1>
                <h2 class=\"page_error_number_error ml-5\">{{ status_code }} - accès refusé</h2>
            </div>
            <div class=\"col col-xs-6 page_error_right_part d-flex flex-column justify-content-center text-center mt-4 mr-5\">              
                <h2 class=\"page_error_h2\"> Désolé </h2>
                <h3 class=\"page_error_h3 pb-3\">Vous n'avez pas accès à cette partie.</h3>
...
{% endblock %}", "@Twig/Exception/error403.html.twig", "/var/www/html/PROJET/projet-PartageVehicules/wiwatt/templates/bundles/TwigBundle/Exception/error403.html.twig");
    }
}
