...
class __TwigTemplate_9f8b43563a8fb22b35a6b73446c9cdb09a03a9221877a1c3610036f47a450d3e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["messageType"] => $context["messageList"]) {
            // line 10
            echo "        ";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($context["messageList"]);
            foreach ($context['_seq'] as $context["_key"] => $context["message"]) {
                // line 11
                echo "            <div class=\"alert alert-";
                echo twig_escape_filter($this->env, $context["messageType"], "html", null, true);
                echo "\">";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['messageType'], $context['messageList'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 14
        echo "</div>
";
...
";
    ...
    {
        return array (  120 => 18,  109 => 19,  107 => 18,  104 => 16,  101 => 14,  95 => 13,  84 => 11,  79 => 10,  75 => 9,  72 => 8,  69 => 6,  59 => 5,  36 => 1,);
    }
...
{# Tous nos templates qui surchargent FOSUser se trouvent dans ce block #}
{% block fos_user_content %}{% endblock fos_user_content %}

{% endblock %}", "@FOSUser/layout.html.twig", "/var/www/html/PROJET/projet-PartageVehicules/wiwatt/templates/bundles/FOSUserBundle/layout.html.twig");
    }
}
