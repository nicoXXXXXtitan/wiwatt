...
// Returns the private 'App\Repository\DateRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DateRepository.php';

return $this->privates['App\\Repository\\DateRepository'] = new \App\Repository\DateRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
